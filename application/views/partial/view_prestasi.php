<div class="col s12 filler">
	<form action="<?php echo site_url("data/prestasi") ?>" method="POST">
	<div class="row">
	...
	<table class="basic_table" id="">
		...
		<?php $i=1;$lid = "";foreach ($data as $d): ?>
			...
			<?php $lid = $d->kode_identitas ?>
				<tr class="lst_pkl">
					<td></td>
					<td><strong><i><?php echo $d->nama_prestasi ?></i></strong> <a href="<?php echo site_url("actions/del_prestasi?d=".base64_encode($d->id)) ?>">Delete</a></td>
...
<div class="modal" id="popupform">
	<div class="modal-content">
		<h3>Tambahkan data Prestasi</h3>
		<form action="<?php echo site_url("actions/save_prestasi") ?>" method="POST">
				...
				<tr>
					...
					<td>
						<div class="input-field">
							<textarea name="nama_prestasi" id="" cols="30" rows="10" required class="materialize-textarea"></textarea>
						</div>
					</td>
				</tr>
				<tr>
