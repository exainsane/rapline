<div class="col s12 filler">
	<form action="<?php echo site_url("data/prakerin") ?>" method="POST">
	<div class="row">
	...
	<table class="basic_table" id="">
		...
		<?php $i=1;$lid = "";foreach ($data as $d): ?>
			...
			<?php $lid = $d->kode_identitas ?>
				<tr class="lst_pkl">
					<td></td>
					<td><strong><i><?php echo $d->lokasi ?></i></strong> <a href="<?php echo site_url("actions/del_pkl?d=".base64_encode($d->id)) ?>">Delete</a></td>
					<td><strong><?php echo $d->durasi ?> (Bulan)</strong></td>
				</tr>
		<?php endforeach ?>
	</table>	
</div>
<div class="modal" id="popupform">
	<div class="modal-content">
		<h3>Tambahkan data PRAKERIN</h3>
		<form action="<?php echo site_url("actions/save_pkl") ?>" method="POST">
			...
			<table>
				...
				<tr>
					<td>Lokasi PRAKERIN</td>
					<td>:</td>
					<td>
						<div class="input-field">
							<textarea name="lokasi" id="" cols="30" rows="10" required class="materialize-textarea"></textarea>
						</div>
					</td>
				</tr>
				<tr>
					<td>Lama Prakerin (Bulan)</td>
					<td>:</td>
					<td>
						<input type="number" name="durasi" required value="1" style="max-width:300px;">
					</td>
				</tr>
				<tr>
					<td>Keterangan</td>
